...
# NOTE: work in progress, doesn't work yet

# Scrape blog posts from the website
url = "https://twitter.com/kaicarver"
...
posts.first(5).each do |post|
  ...
  link = "https://twitter.com/kaicarver/status/{post.at_css('a')[:href]}"
...
posts_regex = /### Recent Twitter Posts\n\n[\s\S]*?(?=<\/td>)/m
